...
export const DEFAULT_CONFIG = {
  ...
  autoApprove: [
    ...
    'Bash(git blame*)',
    'Bash(git describe*)',
    // Reads; the config-write guard separates these from `git config k v`.
    'Bash(git config *)',
    'Bash(git ls-remote*)',
    'Bash(git merge-base*)',
    'Bash(git name-rev*)',
    ...
    'Bash(gh run watch*)',
    'Bash(gh auth status*)',
    // Reads by default; the api-write guard catches -X POST/PUT/PATCH/DELETE
    // and the -f/--field flags that turn it into a write.
    'Bash(gh api *)',
